...
lidOpenedDialog="Quand l'écran du Mac est ouvert"

# Text displayed when the user wants the Mac to start when power cable is plugged

powerPluggedDialog="Quand je branche un cable d'alimentation"

dialogButton1="Appliquer ces réglages"
dialogButton2="Annuler"
titleDialog="Réglages d'alimentation"
messageDialog="Votre Mac peut être démarré lorsque vous branchez un câble d'alimentation ou lorsque vous ouvrez l'écran. \n\nSi vous souhaitez changer ce comportement, cochez ou décochez les réglages suivants et cliquez sur *$dialogButton1*. \n\n **Allumer automatiquement le Mac :**"


successMessage="Les nouveaux réglages ont été appliqués."
