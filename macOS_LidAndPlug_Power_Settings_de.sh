...
# German translation 17/02/2025 by Markus Kachel
...
lidOpenedDialog="wenn ich das Display des Macs aufklappe"

# Text displayed when the user wants the Mac to start when power cable is plugged

powerPluggedDialog="wenn ich das Netzteil anschließe"

dialogButton1="Einstellungen anwenden"
dialogButton2="Abbruch"
titleDialog="Einschalt-Einstellungen"
messageDialog="Ihr Mac kann sich automatisch beim Einstecken des Netzteils oder Aufklappen des Displays einschalten.\n\nWenn Sie dieses Verhalten ändern wollen, aktivieren oder deaktivieren sie die folgenden Optionen und klicken anschlie0end auf *$dialogButton1*.\n\n **Diesen Mac automatisch einschalten...**"


successMessage="Die Einstellungen wurden angewendet."
